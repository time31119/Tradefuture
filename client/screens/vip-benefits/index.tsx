...
const VIP_BENEFITS_DETAIL = [
  ...
  },
  {
    ...
    icon: 'shield-alt',
    title: '预测保险',
    subtitle: '保险仓 40% 赔付保障',
    highlight: '40%',
    color: '#3B82F6',
    description: 'VIP 用户参与预测市场时，可享受保险仓赔付保障，降低预测失败的风险。',
    details: [
      { label: '赔付比例', value: '保险仓价值的 40%' },
      { label: '赔付方式', value: '等值 TFT' },
      { label: '保险仓来源', value: '每笔预测 20% 注入' },
      { label: '保障范围', value: 'VIP 用户专享' },
    ],
    note: '保险仓由平台预测手续费的 20% 持续注入，为用户提供额外的安全保障。',
  },
  {
    id: 5,
    icon: 'sync-alt',
